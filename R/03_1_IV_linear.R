...
ggplot(shocks,
       aes(x = d_tradeotch_p1_lag_2000_2012,
           y = d_tradeusch_p1_2000_2012)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "loess", se = TRUE) +
  geom_smooth(method = "lm", se = TRUE, linetype = "dashed")

#################################################################
## QoQ-linear-IV appraoch for every year (2005–2019)
#################################################################
...
dir.create(
  "plots/iv_qoq/linear_approach",
  recursive = TRUE,
  showWarnings = FALSE
)

dir.create(
  "plots/iv_qoq/linear_approach/slices",
  recursive = TRUE,
  showWarnings = FALSE
)

dir.create(
  "plots/iv_qoq/linear_approach/surfaces",
  recursive = TRUE,
  showWarnings = FALSE
)
...
for (yr in years) {
  ...
  htmlwidgets::saveWidget(
    p_surface,
    file = paste0(
      "plots/iv_qoq/linear_approach/surfaces/ivl_surface_cz_",
      yr,
      ".html"
    ),
    selfcontained = TRUE
  ...
  ggsave(
    filename = paste0(
      "plots/iv_qoq/linear_approach/slices/ivl_slices_cz_",
      yr,
      ".png"
    ),
    plot = p_slices,
...
saveRDS(
  results_iv,
  "plots/iv_qoq/linear_approach/surfaces/all_ivl_surfaces.rds"
)
...
htmlwidgets::saveWidget(
  ...
  "plots/iv_qoq/linear_approach/iv_qoq_animation_2005_2019.html",
...
#################################################################
## 2. QoQ-linear-IV approach pooled in 5-year periods
#################################################################
...
dir.create(
  "plots/iv_qoq/linear_approach/surfaces_5year",
  recursive = TRUE,
  showWarnings = FALSE
)

dir.create(
  "plots/iv_qoq/linear_approach/slices_5year",
  recursive = TRUE,
  showWarnings = FALSE
)
...
for (p in periods5) {
  ...
  htmlwidgets::saveWidget(
    p_surface,
    file = paste0(
      "plots/iv_qoq/linear_approach/surfaces_5year/iv_surface_",
      p,
      ".html"
    ),
    selfcontained = TRUE
  ...
  ggsave(
    filename = paste0(
      "plots/iv_qoq/linear_approach/slices_5year/iv_slices_",
      p,
      ".png"
    ),
    plot = p_slices,
...
saveRDS(
  results_iv_5year,
  "plots/iv_qoq/linear_approach/surfaces_5year/all_iv_surfaces_5year.rds"
)
...
htmlwidgets::saveWidget(
  ...
  "plots/iv_qoq/linear_approach/iv_qoq_animation_5year.html",
